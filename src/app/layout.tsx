...
export default function RootLayout({
  ...
  return (
    <NuqsAdapter>
      <IntlProviderWrapper>
        <SkeletonTheme
          baseColor="rgba(10, 10, 10, 0.1)"
          highlightColor="rgba(68, 68, 68, 0.5)"
        >
          <HtmlWrapper>
            <body
              className={`${tajawal.className} min-h-full bg-background antialiased`}
            >
              <main className="relative flex min-h-dvh w-full flex-col bg-background text-foreground transition-colors">
