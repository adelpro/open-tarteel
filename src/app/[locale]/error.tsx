  ...
  return (
    <div className="flex min-h-screen w-full max-w-md items-center justify-center bg-gray-100 dark:bg-gray-900">
      <div className="mx-auto flex w-full max-w-md flex-col rounded-lg bg-white px-10 py-8 text-center shadow-lg dark:bg-gray-800">
        ...
        <button
          onClick={reset}
          className="mx-2 my-4 w-full rounded-md bg-red-500 py-2 text-white transition-colors duration-300 hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2"
        >
          Try again
        </button>
        <Link
          href="/"
          className="mx-2 w-full rounded-md bg-gradient-to-r from-brand-CTA-blue-600 to-brand-CTA-blue-500 py-2 text-white transition-colors duration-300 hover:to-brand-CTA-blue-600 focus:outline-none focus:ring-2 focus:ring-brand-CTA-blue-500 focus:ring-offset-2"
        >
